 ...
 *
 * The one post below exists to prove the pipeline renders and passes §7 end to
 * end; a pipeline that has never carried a post is not a working pipeline. Its
 * copy has not been read by Jasmine and has not been near the BIC. The site is
 * not live, so nothing is published — but this post does not go out with the
 * launch until she has read it. See docs/CONTENT-MARKETING.md.
 *
 * ---------------------------------------------------------------------------
...
export const POSTS: readonly Post[] = [
  {
    ...
    /* Case 2, quoted for what it was: a negotiation with no price reduction in it.
       ...
       in lib/blog/types.ts. docs/CASE-STUDIES.md permits this use. */
